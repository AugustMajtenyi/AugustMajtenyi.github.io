...
function preload() {
  ...
  function createButtons() {
      ...
      button.position($(window).width()/2 - 90,335+295)
  ...
  function startFightGo() {
        ...
        canMoveB = true
          ...
          resetButton.position($(window).width()/2 - 90,335+500)
